...
const std::string resources_path = "examples/sfml/resources/shader/";

//Resouces retrieving for this example:

//bii://shader/background.jpg
//bii://shader/blink.frag
//bii://shader/blur.frag
//bii://shader/devices.png
//bii://shader/edge.frag
//bii://shader/pixelate.frag
//bii://shader/sansation.ttf
//bii://shader/sfml.png
//bii://shader/storm.vert
//bii://shader/text-background.png
//bii://shader/wave.vert
...
public :
    ...
    bool onLoad()
    {
        ...
        if (!m_texture.loadFromFile(resources_path + "background.jpg"))
            return false;
        m_sprite.setTexture(m_texture);

        // Load the shader
        if (!m_shader.loadFromFile(resources_path + "pixelate.frag", sf::Shader::Fragment))
            return false;
...
public :
    ...
    bool onLoad()
    {
        ...
        // Load the shader
        if (!m_shader.loadFromFile(resources_path + "wave.vert", resources_path + "blur.frag"))
            return false;
...
public :
    ...
    bool onLoad()
    {
        ...
        // Load the shader
        if (!m_shader.loadFromFile(resources_path + "storm.vert", resources_path + "blink.frag"))
            return false;
...
public :
    ...
    bool onLoad()
    {
        ...
        // Load the textures
        if (!m_backgroundTexture.loadFromFile(resources_path + "sfml.png"))
            return false;
        m_backgroundTexture.setSmooth(true);
        if (!m_entityTexture.loadFromFile(resources_path + "devices.png"))
            return false;
        ...
        // Load the shader
        if (!m_shader.loadFromFile(resources_path + "edge.frag", sf::Shader::Fragment))
            return false;
        m_shader.setParameter("texture", sf::Shader::CurrentTexture);
...
int main()
{
    ...
    sf::Font font;
    if (!font.loadFromFile(resources_path + "sansation.ttf"))
        return EXIT_FAILURE;
    Effect::setFont(font);
    ...
    if (!textBackgroundTexture.loadFromFile(resources_path + "text-background.png"))
        return EXIT_FAILURE;
